...
import {
  ...
  TUpdateExtensionRequestDto,
  TUpdateExtensionRequestResponse,
...
export const ExtensionRequestsApi = {
  getExtensionRequests: {
    ...
    fn: async (params?: TGetExtensionRequestsDto): Promise<TGetExtensionRequestsResponse> => {
      ...
      const { data } = await apiClient.get<TGetExtensionRequestsResponse>("/extension-requests", {
        params: queryParams,
      });
      return data;
    },
  ...
  updateExtensionRequestStatus: {
    key: (id: string) => ["ExtensionRequestsApi.updateExtensionRequestStatus", id],
    fn: async (
      id: string,
      ...
      const { data } = await apiClient.patch<TUpdateExtensionRequestStatusResponse>(url, payload);
      return data;
    },
  },
  ...
  updateExtensionRequest: {
    key: (id: string) => ["ExtensionRequestsApi.updateExtensionRequest", id],
    fn: async (
      id: string,
      updateData: TUpdateExtensionRequestDto
    ): Promise<TUpdateExtensionRequestResponse> => {
      const { data } = await apiClient.patch<TUpdateExtensionRequestResponse>(

...
const TaskDetails = () => {
  const { id, title, createdBy, assignee, endsOn, startedOn, status } = useLocalSearchParams();

  console.log("Started On:", startedOn, "Ends On:", endsOn);
    ...
    <ScrollView contentContainerStyle={styles.scrollContent}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.detailRow}>
          ...
          <Text style={styles.detailValue}>{formatDateTime(Number(startedOn))}</Text>
        </View>
        <View style={styles.detailRow}>
          <Text style={styles.detailLabel}>Ends On:</Text>
          <Text style={styles.detailValue}>{formatDateTime(Number(endsOn))}</Text>
        </View>
      </View>
